...
@click.option('--model_channels', help='model channel', metavar='INT',                               default=128, type=int, required=True)
...
def main(**kwargs):
    ...
    if opts.arch == 'ddpmpp':
        ...
        c.network_kwargs.update(channel_mult_noise=1, resample_filter=[1,1], model_channels = opts.model_channels, channel_mult=[2,2,2])
    elif opts.arch == 'ncsnpp':
        c.network_kwargs.update(model_type='SongUNet', embedding_type='fourier', encoder_type='residual', decoder_type='standard')
        c.network_kwargs.update(channel_mult_noise=2, resample_filter=[1,3,3,1], model_channels = opts.model_channels, channel_mult=[2,2,2])
    else:
